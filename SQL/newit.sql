...
select * from OrderDetails where Quantity>12;
select * from employees;
select * from employees where EmployeeID<=2;
select EmployeeID as IdEmpleado, notes as notas from employees where EmployeeID<=2;
select * from categories;
select * from categories where CategoryID>=2;
select * from Products where Price <=50;
select ProductName, Price, Price*2 as precio_de_2 from Products;
...
select count(*) from Products where Price <= 100;
select * from Products where SupplierID = 4 or SupplierID = 5 or SupplierID = 6 order by Price;
select * from Products where SupplierID = 4 or SupplierID = 5 or SupplierID = 6 order by Price desc limit 3;
select * from Products where SupplierID = 4 or SupplierID = 5 or SupplierID = 6 order by Price asc limit 6;